...
import (
	...
	"github.com/aitra-ai/aitra-server/user/billing"
	"github.com/aitra-ai/aitra-server/user/router"
)
...
var cmdLaunch = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		// Start GPU billing background job
		billing.StartGPUBillingJob(cfg)
