...
func (c *paraviewClientImpl) GetTokenByPassword(ctx context.Context, username, password string) (string, error) {
	return "", fmt.Errorf("password grant not supported for paraview SSO")
}
