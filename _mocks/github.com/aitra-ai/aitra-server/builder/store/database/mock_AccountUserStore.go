...
// SetLowBalanceWarn provides a mock function with given fields: ctx, userUUID, lowBalanceWarn
func (_m *MockAccountUserStore) SetLowBalanceWarn(ctx context.Context, userUUID string, lowBalanceWarn float64) error {
	ret := _m.Called(ctx, userUUID, lowBalanceWarn)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, float64) error); ok {
		r0 = rf(ctx, userUUID, lowBalanceWarn)
	} else {
		r0 = ret.Error(0)
	}
...
// MockAccountUserStore_SetLowBalanceWarn_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetLowBalanceWarn'
type MockAccountUserStore_SetLowBalanceWarn_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - userUUID string
//   - lowBalanceWarn float64
func (_e *MockAccountUserStore_Expecter) SetLowBalanceWarn(ctx interface{}, userUUID interface{}, lowBalanceWarn interface{}) *MockAccountUserStore_SetLowBalanceWarn_Call {
	return &MockAccountUserStore_SetLowBalanceWarn_Call{Call: _e.mock.On("SetLowBalanceWarn", ctx, userUUID, lowBalanceWarn)}
}

func (_c *MockAccountUserStore_SetLowBalanceWarn_Call) Run(run func(ctx context.Context, userUUID string, lowBalanceWarn float64)) *MockAccountUserStore_SetLowBalanceWarn_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAccountUserStore_SetLowBalanceWarn_Call) Return(_a0 error) *MockAccountUserStore_SetLowBalanceWarn_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAccountUserStore_SetLowBalanceWarn_Call) RunAndReturn(run func(context.Context, string, float64) error) *MockAccountUserStore_SetLowBalanceWarn_Call {
	_c.Call.Return(run)
	return _c
}

// SetLowBalanceWarnAtNow provides a mock function with given fields: ctx, userUUID
func (_m *MockAccountUserStore) SetLowBalanceWarnAtNow(ctx context.Context, userUUID string) error {
	ret := _m.Called(ctx, userUUID)
...
// MockAccountUserStore_SetLowBalanceWarnAtNow_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetLowBalanceWarnAtNow'
type MockAccountUserStore_SetLowBalanceWarnAtNow_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - userUUID string
func (_e *MockAccountUserStore_Expecter) SetLowBalanceWarnAtNow(ctx interface{}, userUUID interface{}) *MockAccountUserStore_SetLowBalanceWarnAtNow_Call {
	return &MockAccountUserStore_SetLowBalanceWarnAtNow_Call{Call: _e.mock.On("SetLowBalanceWarnAtNow", ctx, userUUID)}
}

func (_c *MockAccountUserStore_SetLowBalanceWarnAtNow_Call) Run(run func(ctx context.Context, userUUID string)) *MockAccountUserStore_SetLowBalanceWarnAtNow_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockAccountUserStore_SetLowBalanceWarnAtNow_Call) Return(_a0 error) *MockAccountUserStore_SetLowBalanceWarnAtNow_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAccountUserStore_SetLowBalanceWarnAtNow_Call) RunAndReturn(run func(context.Context, string) error) *MockAccountUserStore_SetLowBalanceWarnAtNow_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateNegativeBalanceWarnAt provides a mock function with given fields: ctx, userUUID, warnAt
func (_m *MockAccountUserStore) UpdateNegativeBalanceWarnAt(ctx context.Context, userUUID string, warnAt time.Time) error {
...
// MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateNegativeBalanceWarnAt'
type MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call struct {
	*mock.Call
}
...
//   - userUUID string
//   - warnAt time.Time
func (_e *MockAccountUserStore_Expecter) UpdateNegativeBalanceWarnAt(ctx interface{}, userUUID interface{}, warnAt interface{}) *MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call {
	return &MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call{Call: _e.mock.On("UpdateNegativeBalanceWarnAt", ctx, userUUID, warnAt)}
}

func (_c *MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call) Run(run func(ctx context.Context, userUUID string, warnAt time.Time)) *MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call) Return(_a0 error) *MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call) RunAndReturn(run func(context.Context, string, time.Time) error) *MockAccountUserStore_UpdateNegativeBalanceWarnAt_Call {
	_c.Call.Return(run)
	return _c
}
