...
func (_m *MockSpaceResourceStore) Index(ctx context.Context, filter types.SpaceResourceFilter, per int, page int) ([]database.SpaceResource, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, types.SpaceResourceFilter, int, int) ([]database.SpaceResource, int, error)); ok {
		return rf(ctx, filter, per, page)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.SpaceResourceFilter, int, int) []database.SpaceResource); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, types.SpaceResourceFilter, int, int) int); ok {
		r1 = rf(ctx, filter, per, page)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(context.Context, types.SpaceResourceFilter, int, int) error); ok {
...
//   - ctx context.Context
//   - filter types.SpaceResourceFilter
//   - per int
//   - page int
func (_e *MockSpaceResourceStore_Expecter) Index(ctx interface{}, filter interface{}, per interface{}, page interface{}) *MockSpaceResourceStore_Index_Call {
	return &MockSpaceResourceStore_Index_Call{Call: _e.mock.On("Index", ctx, filter, per, page)}
}

func (_c *MockSpaceResourceStore_Index_Call) Run(run func(ctx context.Context, filter types.SpaceResourceFilter, per int, page int)) *MockSpaceResourceStore_Index_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.SpaceResourceFilter), args[2].(int), args[3].(int))
	})
	return _c
}
...
func (_c *MockSpaceResourceStore_Index_Call) RunAndReturn(run func(context.Context, types.SpaceResourceFilter, int, int) ([]database.SpaceResource, int, error)) *MockSpaceResourceStore_Index_Call {
	_c.Call.Return(run)
	return _c
}
