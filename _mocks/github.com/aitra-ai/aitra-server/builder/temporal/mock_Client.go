...
import (
	...
	temporal "github.com/aitra-ai/aitra-server/builder/temporal"
...
func (_m *MockClient) CheckHealth(ctx context.Context, request *client.CheckHealthRequest) (*client.CheckHealthResponse, error) {
...
func (_c *MockClient_CheckHealth_Call) Return(_a0 *client.CheckHealthResponse, _a1 error) *MockClient_CheckHealth_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_CheckHealth_Call) RunAndReturn(run func(context.Context, *client.CheckHealthRequest) (*client.CheckHealthResponse, error)) *MockClient_CheckHealth_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) DescribeTaskQueueEnhanced(ctx context.Context, options client.DescribeTaskQueueEnhancedOptions) (client.TaskQueueDescription, error) {
...
func (_c *MockClient_DescribeTaskQueueEnhanced_Call) Return(_a0 client.TaskQueueDescription, _a1 error) *MockClient_DescribeTaskQueueEnhanced_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_DescribeTaskQueueEnhanced_Call) RunAndReturn(run func(context.Context, client.DescribeTaskQueueEnhancedOptions) (client.TaskQueueDescription, error)) *MockClient_DescribeTaskQueueEnhanced_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_ExecuteWorkflow_Call) Return(_a0 client.WorkflowRun, _a1 error) *MockClient_ExecuteWorkflow_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
// GetScheduleClient provides a mock function with no fields
...
func (_c *MockClient_GetWorkerBuildIdCompatibility_Call) Return(_a0 *client.WorkerBuildIDVersionSets, _a1 error) *MockClient_GetWorkerBuildIdCompatibility_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_GetWorkerBuildIdCompatibility_Call) RunAndReturn(run func(context.Context, *client.GetWorkerBuildIdCompatibilityOptions) (*client.WorkerBuildIDVersionSets, error)) *MockClient_GetWorkerBuildIdCompatibility_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) GetWorkerVersioningRules(ctx context.Context, options client.GetWorkerVersioningOptions) (*client.WorkerVersioningRules, error) {
	ret := _m.Called(ctx, options)
...
func (_c *MockClient_GetWorkerVersioningRules_Call) Return(_a0 *client.WorkerVersioningRules, _a1 error) *MockClient_GetWorkerVersioningRules_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_GetWorkerVersioningRules_Call) RunAndReturn(run func(context.Context, client.GetWorkerVersioningOptions) (*client.WorkerVersioningRules, error)) *MockClient_GetWorkerVersioningRules_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_GetWorkflow_Call) Return(_a0 client.WorkflowRun) *MockClient_GetWorkflow_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_GetWorkflow_Call) RunAndReturn(run func(context.Context, string, string) client.WorkflowRun) *MockClient_GetWorkflow_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_GetWorkflowHistory_Call) Return(_a0 client.HistoryEventIterator) *MockClient_GetWorkflowHistory_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_GetWorkflowHistory_Call) RunAndReturn(run func(context.Context, string, string, bool, enums.HistoryEventFilterType) client.HistoryEventIterator) *MockClient_GetWorkflowHistory_Call {
	_c.Call.Return(run)
	return _c
}

// GetWorkflowUpdateHandle provides a mock function with given fields: ref
func (_m *MockClient) GetWorkflowUpdateHandle(ref client.GetWorkflowUpdateHandleOptions) client.WorkflowUpdateHandle {
	ret := _m.Called(ref)
...
func (_c *MockClient_GetWorkflowUpdateHandle_Call) Return(_a0 client.WorkflowUpdateHandle) *MockClient_GetWorkflowUpdateHandle_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_GetWorkflowUpdateHandle_Call) RunAndReturn(run func(client.GetWorkflowUpdateHandleOptions) client.WorkflowUpdateHandle) *MockClient_GetWorkflowUpdateHandle_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) NewWithStartWorkflowOperation(options client.StartWorkflowOptions, workflow interface{}, args ...interface{}) client.WithStartWorkflowOperation {
	var _ca []interface{}
...
func (_c *MockClient_NewWithStartWorkflowOperation_Call) Return(_a0 client.WithStartWorkflowOperation) *MockClient_NewWithStartWorkflowOperation_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_NewWithStartWorkflowOperation_Call) RunAndReturn(run func(client.StartWorkflowOptions, interface{}, ...interface{}) client.WithStartWorkflowOperation) *MockClient_NewWithStartWorkflowOperation_Call {
	_c.Call.Return(run)
	return _c
}

// NewWorker provides a mock function with given fields: queue, options
func (_m *MockClient) NewWorker(queue string, options worker.Options) worker.Registry {
	ret := _m.Called(queue, options)

	if len(ret) == 0 {
		panic("no return value specified for NewWorker")
	}

	var r0 worker.Registry
	if rf, ok := ret.Get(0).(func(string, worker.Options) worker.Registry); ok {
		r0 = rf(queue, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(worker.Registry)
		}
	}
...
// MockClient_NewWorker_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NewWorker'
type MockClient_NewWorker_Call struct {
	*mock.Call
}

// NewWorker is a helper method to define mock.On call
//   - queue string
//   - options worker.Options
func (_e *MockClient_Expecter) NewWorker(queue interface{}, options interface{}) *MockClient_NewWorker_Call {
	return &MockClient_NewWorker_Call{Call: _e.mock.On("NewWorker", queue, options)}
}

func (_c *MockClient_NewWorker_Call) Run(run func(queue string, options worker.Options)) *MockClient_NewWorker_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(worker.Options))
	})
	return _c
}

func (_c *MockClient_NewWorker_Call) Return(_a0 worker.Registry) *MockClient_NewWorker_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_NewWorker_Call) RunAndReturn(run func(string, worker.Options) worker.Registry) *MockClient_NewWorker_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) QueryWorkflowWithOptions(ctx context.Context, request *client.QueryWorkflowWithOptionsRequest) (*client.QueryWorkflowWithOptionsResponse, error) {
	ret := _m.Called(ctx, request)
...
func (_c *MockClient_QueryWorkflowWithOptions_Call) Return(_a0 *client.QueryWorkflowWithOptionsResponse, _a1 error) *MockClient_QueryWorkflowWithOptions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_QueryWorkflowWithOptions_Call) RunAndReturn(run func(context.Context, *client.QueryWorkflowWithOptionsRequest) (*client.QueryWorkflowWithOptionsResponse, error)) *MockClient_QueryWorkflowWithOptions_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_ScheduleClient_Call) Return(_a0 client.ScheduleClient) *MockClient_ScheduleClient_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *MockClient_SignalWithStartWorkflow_Call) Return(_a0 client.WorkflowRun, _a1 error) *MockClient_SignalWithStartWorkflow_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_SignalWithStartWorkflow_Call) RunAndReturn(run func(context.Context, string, string, interface{}, client.StartWorkflowOptions, interface{}, ...interface{}) (client.WorkflowRun, error)) *MockClient_SignalWithStartWorkflow_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) UpdateWithStartWorkflow(ctx context.Context, options client.UpdateWithStartWorkflowOptions) (client.WorkflowUpdateHandle, error) {
	ret := _m.Called(ctx, options)
...
func (_c *MockClient_UpdateWithStartWorkflow_Call) Return(_a0 client.WorkflowUpdateHandle, _a1 error) *MockClient_UpdateWithStartWorkflow_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_UpdateWithStartWorkflow_Call) RunAndReturn(run func(context.Context, client.UpdateWithStartWorkflowOptions) (client.WorkflowUpdateHandle, error)) *MockClient_UpdateWithStartWorkflow_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_UpdateWorkerBuildIdCompatibility_Call) RunAndReturn(run func(context.Context, *client.UpdateWorkerBuildIdCompatibilityOptions) error) *MockClient_UpdateWorkerBuildIdCompatibility_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateWorkerVersioningRules provides a mock function with given fields: ctx, options
func (_m *MockClient) UpdateWorkerVersioningRules(ctx context.Context, options client.UpdateWorkerVersioningRulesOptions) (*client.WorkerVersioningRules, error) {
	ret := _m.Called(ctx, options)
...
func (_c *MockClient_UpdateWorkerVersioningRules_Call) Return(_a0 *client.WorkerVersioningRules, _a1 error) *MockClient_UpdateWorkerVersioningRules_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_UpdateWorkerVersioningRules_Call) RunAndReturn(run func(context.Context, client.UpdateWorkerVersioningRulesOptions) (*client.WorkerVersioningRules, error)) *MockClient_UpdateWorkerVersioningRules_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateWorkflow provides a mock function with given fields: ctx, options
func (_m *MockClient) UpdateWorkflow(ctx context.Context, options client.UpdateWorkflowOptions) (client.WorkflowUpdateHandle, error) {
	ret := _m.Called(ctx, options)
