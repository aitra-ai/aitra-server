...
// MockGitCallbackComponent_GenSyncVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GenSyncVersion'
type MockGitCallbackComponent_GenSyncVersion_Call struct {
	*mock.Call
}
...
func (_e *MockGitCallbackComponent_Expecter) GenSyncVersion(ctx interface{}, req interface{}) *MockGitCallbackComponent_GenSyncVersion_Call {
	return &MockGitCallbackComponent_GenSyncVersion_Call{Call: _e.mock.On("GenSyncVersion", ctx, req)}
}

func (_c *MockGitCallbackComponent_GenSyncVersion_Call) Run(run func(ctx context.Context, req *types.GiteaCallbackPushReq)) *MockGitCallbackComponent_GenSyncVersion_Call {
...
func (_c *MockGitCallbackComponent_GenSyncVersion_Call) Return(_a0 error) *MockGitCallbackComponent_GenSyncVersion_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockGitCallbackComponent_GenSyncVersion_Call) RunAndReturn(run func(context.Context, *types.GiteaCallbackPushReq) error) *MockGitCallbackComponent_GenSyncVersion_Call {
	_c.Call.Return(run)
	return _c
}

// MCPScan provides a mock function with given fields: ctx, req
func (_m *MockGitCallbackComponent) MCPScan(ctx context.Context, req *types.GiteaCallbackPushReq) error {
	ret := _m.Called(ctx, req)

	if len(ret) == 0 {
		panic("no return value specified for MCPScan")
	}
...
// MockGitCallbackComponent_MCPScan_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MCPScan'
type MockGitCallbackComponent_MCPScan_Call struct {
	*mock.Call
}

// MCPScan is a helper method to define mock.On call
//   - ctx context.Context
//   - req *types.GiteaCallbackPushReq
func (_e *MockGitCallbackComponent_Expecter) MCPScan(ctx interface{}, req interface{}) *MockGitCallbackComponent_MCPScan_Call {
	return &MockGitCallbackComponent_MCPScan_Call{Call: _e.mock.On("MCPScan", ctx, req)}
}

func (_c *MockGitCallbackComponent_MCPScan_Call) Run(run func(ctx context.Context, req *types.GiteaCallbackPushReq)) *MockGitCallbackComponent_MCPScan_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*types.GiteaCallbackPushReq))
	})
	return _c
...
func (_c *MockGitCallbackComponent_MCPScan_Call) Return(_a0 error) *MockGitCallbackComponent_MCPScan_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockGitCallbackComponent_MCPScan_Call) RunAndReturn(run func(context.Context, *types.GiteaCallbackPushReq) error) *MockGitCallbackComponent_MCPScan_Call {
	_c.Call.Return(run)
	return _c
}
